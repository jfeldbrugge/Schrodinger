...
#pragma omp parallel for
    ...
    {
        for(int i1 = 0; i1 < LY - 2; i1 = i1 + 4){Exp(Phi, tau, a2(i1, j1, i1 + 2, j1), i1, j1, i1 + 2, j1);}
        for(int i1 = 1; i1 < LY - 2; i1 = i1 + 4){Exp(Phi, tau, a2(i1, j1, i1 + 2, j1), i1, j1, i1 + 2, j1);}
    }
}
...
#pragma omp parallel for
    for( int j1 = 0; j1 < LX; j1++)
    {
        for(int i1 = 2; i1 < LY - 2; i1 = i1 + 4){Exp(Phi, tau, a2(i1, j1, i1 + 2, j1), i1, j1, i1 + 2, j1);}
        for(int i1 = 3; i1 < LY - 2; i1 = i1 + 4){Exp(Phi, tau, a2(i1, j1, i1 + 2, j1), i1, j1, i1 + 2, j1);}
    }
}
...
#pragma omp parallel for
    for(int j1 = 0; j1 < LX; j1++)
    {
        for(int i1 = 0; i1 < LY - 1; i1 = i1 + 2){Exp(Phi, tau, a1(i1, j1, i1 + 1, j1), i1, j1, i1 + 1, j1);}
    }
}
...
#pragma omp parallel for
    for(int j1 = 0; j1 < LX; j1++)
    {
        for(int i1 = 1; i1 < LY - 1; i1 = i1 + 2){Exp(Phi, tau, a1(i1, j1, i1 + 1, j1), i1, j1, i1 + 1, j1);}
    }
}
...
#pragma omp parallel for
    ...
    {
        for(int j1 = 0; j1 < LX - 2; j1 = j1 + 4){Exp(Phi, tau, a2(i1, j1, i1, j1 + 2), i1, j1, i1, j1 + 2);}
        for(int j1 = 1; j1 < LX - 2; j1 = j1 + 4){Exp(Phi, tau, a2(i1, j1, i1, j1 + 2), i1, j1, i1, j1 + 2);}
    }
}
...
#pragma omp parallel for
    for(int i1 = 0; i1 < LY; i1++)
    {
        for(int j1 = 2; j1 < LX - 2; j1 = j1 + 4){Exp(Phi, tau, a2(i1, j1, i1, j1 + 2), i1, j1, i1, j1 + 2);}
        for(int j1 = 3; j1 < LX - 2; j1 = j1 + 4){Exp(Phi, tau, a2(i1, j1, i1, j1 + 2), i1, j1, i1, j1 + 2);}
    }
}
...
#pragma omp parallel for
    for(int i1 = 0; i1 < LY; i1++)
    {
        for( int j1 = 0; j1 < LX - 1; j1 = j1 + 2){Exp(Phi, tau, a1(i1, j1, i1, j1 + 1), i1, j1, i1, j1 + 1);}
    }
}
...
#pragma omp parallel for
    for(int i1 = 0; i1 < LY; i1++)
    {
        for( int j1 = 1; j1 < LX - 1; j1 = j1 + 2){Exp(Phi, tau, a1(i1, j1, i1, j1 + 1), i1, j1, i1, j1 + 1);}
    }
}
...
#pragma omp parallel for
    for( int i1 = 0; i1 < LY; i1++)
    {
        for(int j1 = 0; j1 < LX; j1++){Phi[i1][j1] = exp( -I * tau * diag(i1,j1)) * Phi[i1][j1];}
    }
}
